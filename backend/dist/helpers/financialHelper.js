...
exports.FinancialHelper = void 0;
...
class FinancialHelper {
     ...
     */
    static calculateSignature(walletId, amount, type, referenceId) {
     ...
     */
    static verifySignature(walletId, amount, type, referenceId, signature) {
...
exports.FinancialHelper = FinancialHelper;
